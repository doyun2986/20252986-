...
#define _EMA_ALPHA 0.00000000000001    // EMA weight of new sample (range: 0 to 1)
...
#define _DUTY_NEU 2750 // servo neutral position (90 degree)
#define _DUTY_MAX 5000 // servo full counterclockwise position (180 degree)
